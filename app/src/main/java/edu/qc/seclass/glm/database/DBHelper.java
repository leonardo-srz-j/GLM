...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "GML.db";
    ...
    String[] Dairy = new String[]{"cheese", "milk", "butter", "sour cream"};
    String[] Alcohol = new String[]{"wine", "beer", "whisky", "vodka"};
    String[] Snacks = new String[]{"doritos", "tostitos", "lays", "oreos"};
    String[] Beverages = new String[]{"coke", "ginger ale", "orange juice", "apple juice", "soymilk"};
    String[] Vegetable = new String[]{"cabbage", "broccoli", "mushroom", "celery"};
    String[] Meats = new String[]{"chicken", "beef", "pork", "shrimp","fish", "sausage"};
    String[][] items = new String[][]{Fruits, Dairy, Alcohol, Snacks, Beverages, Vegetable, Meats};
